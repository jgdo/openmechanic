...
RigidBodyPart::RigidBodyPart(RID rid, FullBody* parent, GameWorld* gameWorld) :
PhysicalObject(rid), _parent(parent), _blockData(3, 3, 3), _gameWorld(gameWorld) {
...
bool RigidBodyPart::addBlock(BlockID blockId, const Eigen::Vector3i& position, btQuaternion const& orientation) {
